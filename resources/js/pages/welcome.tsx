...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-10 text-[#1b1b18] lg:justify-center lg:p-10 dark:bg-[#0a0a0a]">
                <header className="mb-6 w-full max-w-full text-sm not-has-[nav]:hidden lg:max-w-full">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
