...
import { ArrowLeft, Check, ImagePlus, Pencil, Tag, X } from 'lucide-react';
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-nf-muted">
                                Update details, pricing, and category settings.
                            </p>
                        </div>
                    </div>
                        ...
                        <>
                            ...
                            <aside className="flex flex-col gap-5">
                                <section className="rounded-[var(--radius)] bg-white p-5 shadow-[0_10px_24px_rgba(20,18,27,.05)]">
                                    ...
                                    <label
                                        htmlFor="image"
                                        className="group relative flex min-h-52 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed border-nf-green-dark/35 bg-nf-green-light/60 p-5 text-center transition-colors hover:border-nf-green-dark hover:bg-nf-green-light"
                                    >
                                        {imagePreview ? (
                                            <div className="relative flex w-full flex-col items-center gap-3">
                                                <img
                                                    src={imagePreview}
                                                    alt={product.name}
                                                    className="max-h-40 max-w-full rounded-xl object-contain shadow-xs"
                                                />
                                                <span className="text-xs font-bold text-nf-dark-green">
                                ...
                                <div className="rounded-[var(--radius)] bg-nf-ink p-5 text-white">
                                    ...
                                    <p className="mt-2 text-sm leading-6 text-white/70">
                                        Your changes will be saved immediately to
                                        your inventory and updated across your
                                        store.
                                    </p>
                                </div>
